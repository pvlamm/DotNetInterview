...
namespace DotNetInterview.Tests
{
    ...
    public class ListMethodsTests
    {
        ...
        [TestMethod]
        public void DotNetInterview_Core_SortNumbers_SortsCorrectly()
        {
        ...
        [TestMethod]
        public void DotNetInterview_Core_GetNthLargestElement_Gets2ndLargestCorectly()
        {
            var answer = 1104;
        ...
        [TestMethod]
        public void DotNetInterview_Core_GetNthLargestElement_GetsNthBeyondRange()
        {
            var answer = -1;
